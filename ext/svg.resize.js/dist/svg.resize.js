            ...
            case 'rt':
                ...
                this.calc = function (diffX, diffY) {
                    ...
                    if (this.parameters.box.width + snap[0] > 0 && this.parameters.box.height - snap[1] > 0) {
                        ...
                        var scheight = 0, swidth = 0;
                        if (this.parameters.box.width > this.parameters.box.height) {
                            scheight = this.parameters.box.height - snap[1];
                            swidth = scheight * this.parameters.box.width / this.parameters.box.height;
                        } else {
                            swidth = this.parameters.box.width + snap[0];
                            scheight = swidth * this.parameters.box.height / this.parameters.box.width;
                        }
                        if (this.parameters.box.x + swidth <= this.options.constraint.maxX) {
                            this.el.move(this.parameters.box.x, this.parameters.box.y + snap[1]).size(swidth, scheight);
                        }
